  ...
  return (
    <div id="about-me">
      ...
      <div className="text-container">
        ...
        <br></br>
        <p>
          In my free times I love to read books 📙 or try to figure out how can
          I bring to life some batman tech. Some days its unfinished projects
          but most of the days its batman tech that gets me out of bed.
        </p>
      </div>
    </div>
  );
